...
import { connect, bindActionCreators, GetAllRecipes } from "../../redux/actions"
...
const RecipeCard: FC<RecipeCardInterface> = ({ navigation, data, children, setVisible, setToDay, GetAllRecipes }) => {
    ...
    return !data.empty ? (
        ...
        >
            <View style={[styles.Content, styles.ContentEmpty]}>
                <MaterialCommunityIcons name="plus" color={theme.colors.primary} size={26} />
            </View>
        </TouchableHighlight>
    )
}
...
const mapDispatchProps = (dispatch) => bindActionCreators({ GetAllRecipes }, dispatch)
