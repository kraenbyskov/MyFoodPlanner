...
class ParallaxScrollView extends React.Component<ParallaxScrollViewInterface> {
    ...
    renderFixedHeader() {
        ...
        return <View style={Styles.fixedHeader}>{fixedHeader(this._animatedValue)}</View>
    }
    ...
    renderParallaxHeader() {
        ...
        return (
            <Animated.View style={[Styles.parallaxHeader, animationStyle, { height: parallaxHeaderHeight }]}>
