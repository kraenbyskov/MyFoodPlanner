...
import { AppBar as TopAppBar, Button, LogOutButton, TextInput } from "../../components"
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <TopAppBar
                RightSideButtons={
                    <>
                        <Appbar.Action
                            icon={() => <MaterialCommunityIcons color={"black"} name={"bug-outline"} size={26} />}
                            onPress={() => navigation.navigate("BugReport")}
                        />
                        <Appbar.Action
                            icon={() => <MaterialCommunityIcons color={"black"} name={MORE_ICON} size={26} />}
                        />
                    </>
                }
            />
            <ScrollView style={styles.container}>
                ...
                >
                    <TouchableHighlight onPress={() => navigation.navigate("Add", { destination })}>
