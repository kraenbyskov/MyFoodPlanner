...
import { View, StyleSheet, ScrollView, TouchableHighlight, Image, Text } from "react-native"

import { bindActionCreators, connect, GetAllRecipes, addToCustomList } from "../../redux/actions"
...
const CustomListPortal: FC<CustomListPortalInterface> = ({
    ...
    return (
        <Portal>
            <Dialog style={{ backgroundColor: "lightgray" }} visible={visible} onDismiss={hideDialog}>
                <Dialog.Content>
...
const mapDispatchProps = (dispatch) => bindActionCreators({ GetAllRecipes, addToCustomList }, dispatch)
