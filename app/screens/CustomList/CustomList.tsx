...
import { connect, bindActionCreators, deleteFromstCustomList, GetCustomList } from "../../redux/actions"
...
const mapDispatchProps = (dispatch) => bindActionCreators({ deleteFromstCustomList, GetCustomList }, dispatch)
