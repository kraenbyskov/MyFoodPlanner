...
import { Dialog, TextInput as Input, List, DataTable } from "react-native-paper"
...
const RecipeIngredients = ({ data }) => {
    ...
    const AddIngredien = () => {
        const db = firebase.firestore().collection("Allrecipes").doc(data.Id).collection("ingredients").doc(title.value)
