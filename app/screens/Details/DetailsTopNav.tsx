...
import { AddToCustomList, Button, CustomInput as Input, CustomPortal as Portal } from "../../components"
    ...
    return (
        <View>
            <Appbar style={styles.Appbar}>
                ...
                <IconButton color={"#FFFFFF"} size={25} icon="check" onPress={() => addToCustomListDialog(Data)} />
            ...
            >
                ...
                <Input value={stateDescription.value} setValue={setStateDescription} error={!!stateDescription.error} />
            </Portal>
            <AddToCustomList
